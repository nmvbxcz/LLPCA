 function [ rate,Result, optC, optG, decision_values,model ] = mysvmc( x,y,xx,yy,cc, gg, tt, iscv )
%Default
...
model = svmtrain(y, x, ['-t ' num2str(tt) ' -c ' num2str(optC)  ' -b 1 '  ' -g ' num2str(optG) ' -q']);
[Result, accuracy, decision_values] = svmpredict(yy, xx, model,' -b 1 ');
